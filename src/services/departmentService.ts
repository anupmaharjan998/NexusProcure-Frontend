...
export const getDepartments = async (): Promise<Department[]> => {
  try {
    ...
    return [
      { id: 'd-1', name: 'IT', description: 'Information Technology', headId: 'u-1', headName: 'Alice Johnson', employeeCount: 12 },
      { id: 'd-2', name: 'Finance', description: 'Finance Department', headId: 'u-2', headName: 'Bob Smith', employeeCount: 8 },
    ];
  }
};
