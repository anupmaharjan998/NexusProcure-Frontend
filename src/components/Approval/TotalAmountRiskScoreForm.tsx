        ...
        >
            <form>
                <Grid container spacing={2}>
                    <Grid item xs={12}>
                        <TextField label="Min Amount" type="number" fullWidth {...register('minAmount', { required: true })} />
                    </Grid>
                    <Grid item xs={12}>
                        <TextField label="Max Amount" type="number" fullWidth {...register('maxAmount', { required: true })} />
                    </Grid>
                    <Grid item xs={12}>
                        <TextField label="Risk Points" type="number" fullWidth {...register('riskPoints', { required: true })} />
                    </Grid>
                </Grid>
            </form>
        </Modal>
