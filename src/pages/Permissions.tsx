...
export const Permissions = () => {
    ...
    const onSave = async () => {
        ...
        try {
            ...
            setRoles(prev => prev.map(r => r.id === currentRole.id ? {
                ...r,
                permissions: allPermissions.filter(p => selectedPermissionIds.includes(p.id))
            } : r));
                                    ...
                                    <CardContent>
                                        ...
                                        <FormGroup>
                                            {perms.map(p => (
                                                <FormControlLabel
                                                    key={p.id}
                                                    control={<Checkbox checked={selectedPermissionIds.includes(p.id)}
